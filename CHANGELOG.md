...
- Added OWASP Top Ten Web Application Security Risks 2025 as an explicit cross-cutting lens for `agentic-security-assessment` and normalized `dotnet-agentic-security` Web Top Ten wording with C# remediation guidance.
- Added official OWASP Web Top Ten 2025 identifiers (`A01:2025` through `A10:2025`) to `agentic-security-assessment` and `dotnet-agentic-security`, including C# remediation examples.
